  ...
  return (
    <LegalPage
      ...
      sections={[
        ...
        { heading: "Third parties", text: "We share data with payment processors (PayFast and Ozow), database hosting (Supabase), and shipping carriers only as needed to fulfill your order." },
