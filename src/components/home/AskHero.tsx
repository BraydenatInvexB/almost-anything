...
const DESIRES = [
  { q: "louis vuitton neverfull", name: "Louis Vuitton Neverfull MM", price: 11400, days: "3–5", img: IMG("photo-1584917865442-de89df76afd3") },
  ...
  { q: "ray-ban wayfarer", name: "Ray-Ban Wayfarer", price: 2150, days: "2–5", img: IMG("photo-1511499767150-a48a237f0083") },
];
...
export function AskHero() {
  ...
  return (
    <section className="relative overflow-hidden rounded-[32px] border border-neutral-200 bg-white shadow-[0_12px_50px_-24px_rgba(0,0,0,0.25)]">
      <div className="pointer-events-none absolute -left-24 -top-24 h-80 w-80 rounded-full bg-[#CDFF00]/12 blur-3xl" />
      ...
      <div className="relative grid grid-cols-1 lg:grid-cols-[1.1fr_1fr]">
        ...
        <div className="flex flex-col justify-center px-6 py-12 sm:px-10 sm:py-16">
          ...
          <h1 className="mt-6 text-4xl font-extrabold leading-[1.04] tracking-tight text-neutral-900 sm:text-6xl">
            If you can name it,
            <br />
            <span className="text-[#FF6B57]">we have it.</span>
          </h1>
          ...
          <div className="mt-8 flex flex-wrap items-center gap-x-6 gap-y-2 text-sm text-neutral-500">
            <span className="inline-flex items-center gap-1.5">
              <Zap className="h-4 w-4 text-[#FF6B57]" /> Instant pricing
            </span>
            <span className="inline-flex items-center gap-1.5">
              <Truck className="h-4 w-4 text-[#FF6B57]" /> Delivered to you
            </span>
            <span className="inline-flex items-center gap-1.5">
              <ShieldCheck className="h-4 w-4 text-[#FF6B57]" /> Secure checkout
            </span>
          </div>
        </div>
        ...
        <div className="relative flex flex-col justify-center gap-4 border-t border-neutral-200 bg-linear-to-br from-[#f4f7ec] via-neutral-50 to-[#eef4fb] px-6 py-10 sm:px-8 lg:border-l lg:border-t-0">
          <div className="flex items-center gap-2 text-xs font-medium text-neutral-500">
            <span className="relative flex h-2 w-2">
              <span className="absolute inline-flex h-full w-full animate-ping rounded-full bg-[#CDFF00] opacity-75" />
