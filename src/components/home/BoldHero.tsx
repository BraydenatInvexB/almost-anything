...
const DESIRES = [
  { q: "louis vuitton neverfull", name: "Louis Vuitton Neverfull", price: 11400, days: "3–5", img: IMG("photo-1584917865442-de89df76afd3") },
  { q: "playstation 5 console", name: "PlayStation 5 Console", price: 8999, days: "2–4", img: IMG("photo-1606813907291-d86efa9b94db") },
  { q: "nike air max sneakers", name: "Nike Air Max", price: 2499, days: "3–6", img: IMG("photo-1542291026-7eec264c27ff") },
  { q: "tag heuer carrera watch", name: "Tag Heuer Carrera", price: 42000, days: "4–7", img: IMG("photo-1524592094714-0f0654e20314") },
  { q: "nespresso coffee machine", name: "Nespresso Vertuo", price: 3200, days: "2–4", img: IMG("photo-1517668808822-9ebb02f2a0e6") },
];

const STICKERS = [
  { label: "1,000s in stock", bg: "bg-[#CDFF00]", rotate: "-rotate-2" },
  { label: "Delivered fast", bg: "bg-[#5BC8FF]", rotate: "rotate-2" },
  { label: "One simple price", bg: "bg-[#FF6B57] text-white", rotate: "-rotate-1" },
];
      ...
      <div className="grid grid-cols-1 lg:grid-cols-[1.12fr_1fr]">
        ...
        <div className="px-6 py-10 sm:px-10 sm:py-14">
          <span className="inline-flex items-center gap-2 rounded-full border-2 border-black bg-white px-3 py-1 text-xs font-extrabold uppercase tracking-wide">
            <span className="h-2 w-2 rounded-full bg-[#CDFF00] ring-1 ring-black" />
          ...
          <h1 className="mt-6 text-5xl font-black uppercase leading-[0.92] tracking-tight text-black sm:text-7xl">
            ...
            <br />
            We&apos;ve{" "}
            <span className="inline-block -rotate-1 bg-[#CDFF00] px-2 ring-2 ring-black">
              got it.
            </span>
          </h1>
          ...
          >
            ...
            <button
              type="submit"
              className="flex h-11 shrink-0 items-center gap-1.5 rounded-xl border-2 border-black bg-black px-5 text-sm font-extrabold uppercase text-white transition-colors hover:bg-[#CDFF00] hover:text-black"
            >
              Find it
        ...
        <div className="relative flex flex-col justify-center gap-4 border-t-[3px] border-black bg-[#CDFF00] px-6 py-10 sm:px-8 lg:border-l-[3px] lg:border-t-0">
          ...
          >
            <div className="flex items-center gap-4">
              ...
              <div className="min-w-0 flex-1">
                <span className="inline-flex items-center gap-1 rounded-full border-2 border-black bg-[#CDFF00] px-2 py-0.5 text-[10px] font-extrabold uppercase">
            ...
            <Link
              ...
              className="mt-3 flex w-full items-center justify-center gap-1.5 rounded-xl border-2 border-black bg-black py-2.5 text-xs font-extrabold uppercase text-white transition-colors hover:bg-[#CDFF00] hover:text-black"
            >
              Buy it now
